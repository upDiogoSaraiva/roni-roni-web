// CLI: busca resultados da fonte (RESULTS_SOURCE_URL ou o results_source.json da edição) e
// sincroniza o store dessa edição. Equivalente ao botão "Buscar resultados" do Admin.
//   node scripts/fetch_results.mjs [competição]   (por defeito wc2026)
...
const seed = read(`${compRoot}/seed.json`);
...
const storePath = join(root, compRoot, 'store.json');
